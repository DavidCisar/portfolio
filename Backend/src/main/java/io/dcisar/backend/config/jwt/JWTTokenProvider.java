...
import io.dcisar.backend.user.UserPrincipal;
...
import static io.dcisar.backend.config.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(DCISAR).build();
